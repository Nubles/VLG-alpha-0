...
Text labels and detailed strings still remain in the window title and console/debug log:
...
## Why Text Rendering Is Deferred

The project does not yet have an asset pipeline, font loading, or a UI layout system. Adding a font library, ImGui, or a third-party UI dependency would be larger than this milestone. Text rendering should be introduced only when the project deliberately accepts the asset and layout scope.
